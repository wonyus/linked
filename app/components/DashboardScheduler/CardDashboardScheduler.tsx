...
export interface ICardDashboardScheduler {
    count?: number;
    text: string;
    isLoading: boolean;
    }
const CardDashboardScheduler = ({ count, text, isLoading }: ICardDashboardScheduler) => {
    return (
        <Box>
            <Paper>
...
export default CardDashboardScheduler;